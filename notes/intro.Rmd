...
Go to https://github.com/uc-dataviz/course for the course site. This contains the course objectives, required readings, schedules, slides, etc.

## Enrollment in the course

Enrollment target number is 20. [If you have not already completed the petition to enroll, please do so.](https://github.com/uc-dataviz/course/issues/9)
