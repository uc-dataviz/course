...
Let's start with a shapefile for state boundaries in the United States.^[Originally obtained from the Census Bureau.] We'll use `readShapePoly()` from the `maptools` package to read in the data file:
