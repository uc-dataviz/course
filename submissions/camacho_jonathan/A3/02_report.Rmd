...
One of the This homework contains two part:

- Question one: Merging of Gapminder and Geonames datasets into one. And plotting a graph showing the relationship between life expectancy and population density. 

The graph does not indicates a clear correlation between life expectancy and population density. 

Similarly, the graph does not indicate a clear connection between life expectancy and the number of individuals living in proximity or population density. 
