---
title: "Assignment 2: Brian Pennington"
...
##Unmodified Network
![Unmodified Network](../Assignment 2/Networks/Control.png)

##Centrality Network: Color
![Centrality Network Color](../Assignment 2/Networks/degree continuous color.png)

##Centrality Network: Size
![Centrality Network Size](../Assignment 2/Networks/degree by size.png)

##Betweenness Network: Color
![Betweenness Network Color](../Assignment 2/Networks/betweenness continuous color.png)

##Betweenness Network: Size
![Betweenness Network Size](../Assignment 2/Networks/betweenness size.png)

##[Closeness Network: Color
![Closeness Network Color](../Assignment 2/Networks/closeness continuos color.png)

##Closeness Network: Size
![Closeness Network Size](../Assignment 2/Networks/closeness size.png)
...
data <- read.csv("Centrality Signal Detection.csv")
```
