...
Creating a dashboard was the logical choice as there was a massive amount of information that I needed to convey very quickly and throughly. Segmenting the dashboard by creating individual pages allowed me to maintain focus for the audience. As opposed to putting everything in one page which may overwhelm the user with too much information which can lead to misinterpretaiton of misunderstanding of the presented data. By making this visualization a functional dashboard I also was able to make it personal to the individual user. For instance, a parent using the dashboard may only be interested in their child's school, which may drive them to explore more about their child's school and may lead to exploring others. If the audience is policy makers, for instance a school board member, it would allow them to get a better picture of which schools are performing and which are not, prompting further discussion or action in future school board meetings. 
